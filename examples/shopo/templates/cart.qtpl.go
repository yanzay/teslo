...
//line examples/shopo/templates/cart.qtpl:1
package templates
...
func StreamCartWidget(qw422016 *qt422016.Writer, items []*Item) {
  ...
  <div id="cart">
    <ul>
    `)
	//line examples/shopo/templates/cart.qtpl:4
	for _, item := range items {
		//line examples/shopo/templates/cart.qtpl:4
		qw422016.N().S(`
      <li>`)
		//line examples/shopo/templates/cart.qtpl:5
		...
		qw422016.N().S(`</li>
    `)
		//line examples/shopo/templates/cart.qtpl:6
	}
	//line examples/shopo/templates/cart.qtpl:6
	qw422016.N().S(`
    </ul>
...
`)
//line examples/shopo/templates/cart.qtpl:9
}
